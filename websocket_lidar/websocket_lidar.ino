        ...
        switch (status) {
            ...
            case 3:
                ...
                if (lidarFrame.protocolVersion == PROTOCOL_VERSION) {
                    ...
                    Serial.println("ERROR: Frame Protocol Version Failed");
                    status = 0;
                }
                break;
            case 4:
                ...
                if (lidarFrame.frameType == FRAME_TYPE) {
                    ...
                    Serial.println("ERROR: Frame Type Failed");
                    status = 0;
                }
                break;
            case 5:
            ...
            case 7:
                ...
                break;
            case 8:
                lidarFrame.parameters[0] = by; // For simplicity, only using the first byte
                if (1 == lidarFrame.parameterLength) {
                    status = 9;
                }
                break;
            case 9:
